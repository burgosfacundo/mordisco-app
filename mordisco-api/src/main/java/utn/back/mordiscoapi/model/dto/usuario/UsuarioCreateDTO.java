...
public record UsuarioCreateDTO(
        ...
        @Pattern(regexp = ValidationConstants.NOMBRE_PATTERN, message = ValidationConstants.NOMBRE_MESSAGE)
        String nombre,
        ...
        @Size(
                min = ValidationConstants.TELEFONO_MIN_LENGTH,
                max = ValidationConstants.TELEFONO_MAX_LENGTH,
                message = "El teléfono debe tener entre " + ValidationConstants.TELEFONO_MIN_LENGTH + " y " +
                        ValidationConstants.TELEFONO_MAX_LENGTH + " caracteres")
